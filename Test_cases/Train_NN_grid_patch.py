# -*- coding: utf-8 -*-
"""
Created on Wed Sep  4 15:29:20 2019
...
if __name__ == '__main__':   
    ...
    polygons_with_target_edge_length=np.array(polygons_with_target_edge_length).reshape(len(polygons_with_target_edge_length[:100]),2*nb_of_edges+1)
...
#        
    ...
    for t in range(nb_of_epochs):
        ...
        if t%10==0: 
            ...
            test_loss=loss_func(out_test,y_variable_test).item()
            print("Epoch:",t,"Training Loss:",sum_loss/(x_variable.size(0)),test_loss/(x_variable_test.size(0)))
            my_net.train()
